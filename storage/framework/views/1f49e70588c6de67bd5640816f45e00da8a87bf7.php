...
unset($__errorArgs, $__bag); ?>"
                            name="no_hp" value="<?php echo e(old('no_hp')); ?>" required autocomplete="no_hp">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group row">
                <label for="password-confirm" class="col-md-4 col-form-label text-md-right">Ulang Kata Sandi</label>
            ...
            <div class="signup-link">
                Sudah mendaftar? <a href="<?php echo e(url('/login')); ?>">Login</a></div>
        </form>
    </div>
</div>
<!-- <div class="container"> -->
...
<?php echo $__env->make('layouts/main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\tukau\resources\views/auth/register.blade.php ENDPATH**/ ?>