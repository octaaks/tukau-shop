                            ...
                            <ul class="px-2 navbar-nav ml-auto">
                                ...
                                <?php if(auth()->guard()->guest()): ?>
                                    <?php if(Route::has('login')): ?>
                                        <li class="nav-item">
                                            <a class="px-2 nav-link" href="<?php echo e(route('login')); ?>"><?php echo e(__('Login')); ?></a>
                                        </li>
                                    <?php endif; ?>
                                    
                                    <?php if(Route::has('register')): ?>
                                        <li class="nav-item">
                                            <a class="px-2 nav-link" href="<?php echo e(route('register')); ?>"><?php echo e(__('Register')); ?></a>
                                        </li>
                                    <?php endif; ?>
                                <?php else: ?>
...
</html><?php /**PATH F:\OAX\DOC\KP-TA\KP 2\tukau\resources\views/layout/main.blade.php ENDPATH**/ ?>