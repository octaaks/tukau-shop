        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-4 col-12 text-center">
                    <h2 class="my-md-3 site-title text-white">Warunk!!</h2>
                </div>
                <div class="col-md-4 col-12 text-right">
                    <p class="my-md-4 header-links">
                        <a href="#" class="px-2"> Sign In</a>
                        <a href="#" class="px-2"> Create Account </a>
                    </p>
                </div>
            </div>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\Warunkkk!!\resources\views/layout/main.blade.php ENDPATH**/ ?>